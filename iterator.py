...
class Iterator(object):
    ...
    def get_test_data(self,datetimes,batch_size):
        ...
        return frame_dats.reshape([batch_size,cfg.IN_SEQ+cfg.OUT_SEQ,720,900,1])
    ...
    def get_crop(self, date_times,batch_size):
        ...
        for i in range(len(date_times)):
            ...
            in_paths = [os.path.join(in_dir, str(i) + '.png') for i in range(1, cfg.IN_SEQ + 1)]
...
if __name__ == '__main__':
    it = Iterator(time_interval=['201502211924', '201504210000'],
                  sample_mode="sequent",
                  seq_len=cfg.IN_SEQ + cfg.OUT_SEQ,stride=1,mode='online')
    sample,*_= it.sample(2)
    sample1=sample
